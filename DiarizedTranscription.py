...
def main(file_path, min_speakers):
    ...
    try:
        FasterWhisperPath= script_dir / "models" / "models--Systran--faster-whisper-medium" / "snapshots" / "08e178d48790749d25932bbc082711ddcfdfbc4f"
    ...
    try:
        ...
        config_path = script_dir / "models" / "pyannote_diarization_config.yaml" / "config.yaml"
...
try:
    ...
    # if __name__ == "__main__":
    #     output=main("D:/Downloads/tvpatrol.mp3", 2)
